...
namespace Hedra
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Hedra.AutoSDKRetryOptions Retry { get; set; } = new global::Hedra.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Hedra.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Hedra.IAutoSDKHook>();
        ...
        public global::Hedra.AutoSDKClientOptions AddHook(
            global::Hedra.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Hedra.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Hedra.AutoSDKClientOptions UseAuthorizationProvider(
            global::Hedra.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Hedra.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Hedra.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Hedra.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Hedra.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Hedra.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Hedra.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Hedra.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Hedra.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Hedra.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Hedra.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Hedra.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Hedra.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Hedra.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Hedra.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Hedra.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Hedra.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Hedra.AutoSDKClientOptions clientOptions,
            global::Hedra.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Hedra.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Hedra.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Hedra.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Hedra.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Hedra.IAutoSDKHook, global::Hedra.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Hedra.AutoSDKHookContext context)
        {
