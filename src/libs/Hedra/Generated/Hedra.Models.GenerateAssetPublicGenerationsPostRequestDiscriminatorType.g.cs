    ...
    public static class GenerateAssetPublicGenerationsPostRequestDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this GenerateAssetPublicGenerationsPostRequestDiscriminatorType value)
        {
            return value switch
            {
                ...
                GenerateAssetPublicGenerationsPostRequestDiscriminatorType.TextToMusic => "text_to_music",
                ...
                GenerateAssetPublicGenerationsPostRequestDiscriminatorType.VideoBackgroundRemoval => "video_background_removal",
        ...
        public static GenerateAssetPublicGenerationsPostRequestDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "text_to_music" => GenerateAssetPublicGenerationsPostRequestDiscriminatorType.TextToMusic,
                ...
                "video_background_removal" => GenerateAssetPublicGenerationsPostRequestDiscriminatorType.VideoBackgroundRemoval,
