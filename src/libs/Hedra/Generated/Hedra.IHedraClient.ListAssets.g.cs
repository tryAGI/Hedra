...
namespace Hedra
{
    public partial interface IHedraClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Hedra.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Hedra.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Hedra.Asset>>> ListAssetsAsResponseAsync(
            global::Hedra.AssetType type,
            string? ids = default,
            global::Hedra.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
